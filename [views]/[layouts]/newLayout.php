...
<!--                                <a class="brand" href="/"><img src="/images/logo-default-149x46.png" alt="" width="149" height="46"></a>-->
                        ...
                        <div class="rd-navbar-project rd-navbar-modern-project">
                            <div class="rd-navbar-project-modern-header">
                                <h4 class="rd-navbar-project-modern-title"><?=$_GLOBALS['textOnRight']->attrs['anons']?></h4>
                                <div class="rd-navbar-project-hamburger" data-multitoggle=".rd-navbar-main" data-multitoggle-blur=".rd-navbar-wrap" data-multitoggle-isolate="data-multitoggle-isolate">
                                    <div class="project-close"><span></span><span></span></div>
                                </div>
                            </div>
                            <div class="rd-navbar-project-content rd-navbar-modern-project-content">
                                <div>
                                    <p class="text-spacing-25"><?=$_GLOBALS['textOnRight']->attrs['descr']?></p>
                                    <div class="row row-10 gutters-10" data-lightgallery="group">

                                    <?if($_GLOBALS['textOnRight']->attrs['pics'] && count($_GLOBALS['textOnRight']->attrs['pics'])):?>
                                        <?foreach ($_GLOBALS['textOnRight']->attrs['pics'] as $pic):?>
                                            <div class="col-6 col-lg-4">
                                                <!-- Thumbnail Classic-->
                                                <article class="thumbnail thumbnail-mary">
                                                    <div class="thumbnail-mary-figure"><img src="<?=Media::img($pic->path.'').'&width=124&height=124'?>" alt="" width="124" height="124">
                                                    </div>
                                                    <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=Media::img($pic->path.'').''?>" data-lightgallery="item"><img src="<?=Media::img($pic->path.'').'&width=124&height=124'?>" alt="" width="124" height="124"></a>
                                                    </div>
                                                </article>
                                            </div>
                                        <?endforeach;?>
                                    ...
                                    <ul class="rd-navbar-modern-contacts">
                                        <li>
                                            <div class="unit unit-spacing-sm">
                                                ...
                                                <div class="unit-body">
<!--                                                    <a class="link-phone" href="tel:--><?//=Settings::val('contactsPhone')?><!--">--><?//=Settings::val('contactsPhone')?><!--</a>-->
                                                    <?$phones = explode(',', Settings::val('contactsPhone'))?>
                                        ...
                                        <li>
                                            <div class="unit unit-spacing-sm">
                                                ...
                                                <div class="unit-body"><a class="link-location" href="#" onclick="return false; "><?=Settings::val('contactsAddress')?></a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="unit unit-spacing-sm">
                                                ...
                                                <div class="unit-body">
                                                    <?foreach(explode(',', Settings::val('contactsEmail')) as $email):?>
                                                        <a class="link-email" href="mailto:<?=$email?>"><span class="__cf_email__" ><?=$email?></span></a>
                                                    <?endforeach;?>
                                    ...
                                    <?foreach ($_GLOBALS['social'] as $item):?>
                                        <li><a class="icon fa <?=$item['icon']?>" href="<?=$item['href']?>" title="<?=$item['title']?>" target="_blank"></a></li>
                                    <?endforeach;?>
                                    </ul>
                                </div>
                            </div>
