...
if($_SERVER['SERVER_ADDR'] == '127.0.0.1')
{
    ...
    define('DB_NAME', 'deparket_new2222');
}
else
{
    define('DB_USER', 'dpark_dparketk');
    define('DB_PASSWORD', 'Cmtp8&71277Qt1Miyt');
    define('DB_HOST', 'srv-db-plesk04.ps.kz:3306');
    define('DB_NAME', 'dparketk_newdeparketdb');
}
...
#	лэйаут по умолчанию
$_CONFIG['DEFAULT_LAYOUT'] = 'newLayout.php';
...
//  непонятно где юзается, выяснить
$_CONFIG['LANGS']=array(
