	...
	<div class="entities" >
		...
		<div class="tree">
			...
			<form id="tree-form" method="post" action="/<?=ADMIN_URL_SIGN?>/entity/treeSaveChanges" target="frame1" onsubmit="Slonne.Entities.treeSaveChanges(); return false;  ">
                ...
                <hr>
                <a id="add-element-to-root" class="btn btn-success btn3d xs" style="font-size: .8em; display: inline-block; margin: 4px 0 10px 0;  " href="#new_sub_element" onclick="Slonne.Entities.edit('<?=$essence->code?>', 0, '<?=($essence->jointFields ? Entity2::TYPE_ELEMENTS : Entity2::TYPE_BLOCKS)?>', Slonne.Entities.lang, '0'); ; return false;"> + элемент в корень</a>
                <p >
				<input class="btn btn-default btn3d" id="save-idx-tree-btn" type="submit" value="Сохранить изменения в дереве" />
